...
const index_tier_2 = () => {
    return sumArrayWithReduce([getSelectValue('mySelect5'), getSelectValue('mySelect6')]);
};

const index_tier_3 = () => {
    return sumArrayWithReduce([getSelectValue('mySelect7'), getSelectValue('mySelect8'), getSelectValue('mySelect9')]);
};
...
function total_tier() {
    ...
    document.getElementById('total_allk').innerText =
        index_tier_1() + index_tier_2() + index_tier_3() + index_tier_4() + index_tier_5() + ' điểm';
    showUploadImg();
}
...
const showUploadImg = () => {
    ...
    if (!require_upload_img.every((element) => element === 0 || element === '0')) {
    }
...
async function mark() {
    try {
        let postData = JSON.stringify({
            ...
            third: [getSelectValue('mySelect7'), getSelectValue('mySelect8'), getSelectValue('mySelect9')],
            fourth: [getSelectValue('mySelect10'), getSelectValue('mySelect11'), getSelectValue('mySelect12')],
            class: cls,
            mssv: mssv,
            fifth: [
                getSelectValue('mySelect13'),
            ...
            total: index_tier_1() + index_tier_2() + index_tier_3() + index_tier_4() + index_tier_5(),
        });
